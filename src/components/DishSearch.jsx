      ...
      <Box alignItems="center" display="flex" flexDirection="column">
        ...
        <Box mb={4}>
          <Button
            ...
            boxShadow={selectedFilter === "Vegan" ? "10px 10px 10px #6c81a3" : ""}
          ...
          <Button
            ...
            boxShadow={selectedFilter === "Vegetarian" ? "10px 10px 10px #6c81a3" : ""}
            mr={2}
          >
            Vegetarian
          </Button>
          <Button
            ...
            boxShadow={selectedFilter === "Pescatarian" ? "10px 10px 10px #6c81a3" : ""}
          >
            Pescatarian
          </Button>
        </Box>
